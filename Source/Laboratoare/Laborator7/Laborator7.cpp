...
{
	{
		...
		modelMatrix = glm::translate(modelMatrix, glm::vec3(0, -0.3, 0.8));
		modelMatrix = glm::scale(modelMatrix, glm::vec3(0.8 * 2, 2, 1));
		modelMatrix = glm::scale(modelMatrix, glm::vec3(2, 1.4, 1.4));
	...
	// Render ground
	{
		...
		RenderSimpleMesh(meshes["plane"], shaders["ShaderLab7"], modelMatrix, glm::vec3(0.5, 0.6, 0.6));
	}
