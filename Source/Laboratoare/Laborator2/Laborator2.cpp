...
void Laborator2::Init()
{
	...
	// Create a mesh box using custom data
	{
		...
		vector<VertexFormat> vertices2
		{
			...
			// TODO: Complete the information for the cube
			VertexFormat(glm::vec3(0, 5,  0), glm::vec3(0, 0, 1)), //vf 1
			VertexFormat(glm::vec3(0, 0,  0), glm::vec3(0, 0, 1)), //vf 0
			VertexFormat(glm::vec3(0, 0,  5), glm::vec3(0, 0, 1)), //vf 2

			VertexFormat(glm::vec3(0, 5,  0), glm::vec3(1, 0, 0)), //vf 1
			VertexFormat(glm::vec3(5, 0,  0), glm::vec3(1, 0, 0)), //vf 3
			VertexFormat(glm::vec3(0, 0,  0), glm::vec3(1, 0, 0)), //vf 0

			VertexFormat(glm::vec3(0, 0,  0), glm::vec3(0, 1, 0)), //vf 0
			VertexFormat(glm::vec3(5, 0,  0), glm::vec3(0, 1, 0)), //vf 3
			VertexFormat(glm::vec3(0, 0,  5), glm::vec3(0, 1, 0)), //vf 2

			VertexFormat(glm::vec3(0, 5,  0), glm::vec3(0, 0, 0)), //vf 1
			VertexFormat(glm::vec3(5, 0,  0), glm::vec3(0, 0, 0)), //vf 3
			VertexFormat(glm::vec3(0, 0,  5), glm::vec3(0, 0, 0)), //vf 2
		...
		vector<VertexFormat> vertices3
		{
			...
			// TODO: Complete the information for the cube
			VertexFormat(glm::vec3(0, 0,  0), glm::vec3(0, 0, 1)), //vf 0
			VertexFormat(glm::vec3(0, 2,  0), glm::vec3(1, 1, 0)), //vf 1
			VertexFormat(glm::vec3(2, 2,  0), glm::vec3(1, 0, 0)),
		...
		Mesh *patr = CreateMesh("patr", vertices3, indices3);
...
void Laborator2::Update(float deltaTimeSeconds)
{
	...
	RenderMesh(meshes["cube3"], shaders["VertexColor"], glm::vec3(-.6f, 1.5f, 1), glm::vec3(0.25f));
	
	RenderMesh(meshes["tetr"], shaders["VertexColor"], glm::vec3(2, 0, 0), glm::vec3(0.25f));

	RenderMesh(meshes["patr"], shaders["VertexColor"], glm::vec3(4, 0, 0), glm::vec3(0.45f));
